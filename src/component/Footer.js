            ...
            <div className="container text-center text-md-start mt-5">
              <div className="row mt-3">
                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 mt-5">
                  <h6 className="text-uppercase fw-bold">DahalTech</h6>
                  <hr
                ...
                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 mt-5">
                  ...
                  />
                  <p>
                    <i className="fas fa-home mr-3"></i> Kathmandu, koteswor,
                  </p>
                  <p>
                    <i className="fas fa-envelope mr-3"></i> Dahaltech@gmail.com
                  </p>
                  <p>
                    <i className="fas fa-phone mr-3"></i> 9847343494
                  </p>
                  <p>
                    <i className="fas fa-print mr-3"></i>9876452434
                  </p>
                </div>
              </div>
            </div>
